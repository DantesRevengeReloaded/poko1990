...
destination = '/home/konstantinosthegreat/Music/YouTube Downloads/'
def yturl() :
...
def singledl():
    try :
        ...
        new_file = base + '.mp3'
        new_file = str(numsong) + new_file
        os.rename(dlfile, new_file)
        numsong += 1
        #if new_file in os.listdir(destination) :
           # global source
            #source = destination + new_file
            #global dest
            #dest = destination + str(numsong) + new_file
